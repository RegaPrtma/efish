        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="statistic-block block">
              <div class="progress-details d-flex align-items-end justify-content-between">
                <div class="title">
                  <div class="icon"><i class="icon-contract"></i></div><strong>Semua daftar Ikan</strong>
                </div>
                <div class="number dashtext-2">{{ $produk }}</div>
              </div>
              <div class="progress progress-template">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="statistic-block block">
              <div class="progress-details d-flex align-items-end justify-content-between">
                ...
                <div class="number dashtext-3">{{ $pesan }}</div>
              </div>
              <div class="progress progress-template">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="statistic-block block">
              <div class="progress-details d-flex align-items-end justify-content-between">
                ...
                <div class="number dashtext-4">{{ $kirim }}</div>
              </div>
              <div class="progress progress-template">
